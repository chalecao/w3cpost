...
如果不创建一个<span>元素，[我们](https://www.w3cdoc.com)可以通过设置的:first-letter伪元素来为其添加样式。这个时候，看起来好像是创建了一个虚拟的<span>元素并添加了样式，但实际上文档树中并不存在这个<span>元素。
