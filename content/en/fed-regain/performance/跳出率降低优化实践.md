...
[我们](https://www.w3cdoc.com)对该<a href="https://developer.mozilla.org/docs/Web/CSS/@font-face/font-display" rel="noopener">font-display属性</a>进行了试验，因为这会影响 LCP 和 CLS。[我们](https://www.w3cdoc.com)尝试了`font-display: auto;`，然后切换到`font-display: swap;`. 这最初会以最佳匹配和可用字体呈现文本，然后在下载后切换到该字体。这导致[我们](https://www.w3cdoc.com)的文本渲染速度很快，与网络速度无关。
