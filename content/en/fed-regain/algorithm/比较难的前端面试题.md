...
<img loading="lazy" class="aligncenter" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2018/12/img_5c17cd5179e3b.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2018/12/img_5c17cd5179e3b.png?x-oss-process=image/format,webp" width="273" height="222" /> 

当调用栈为空时， 主线程会从任务队列里取一条消息并放入当前的调用栈当中执行， 主线程会一直重复这个动作直到消息队列为空。 这个过程就叫做事件循环 （event-loop）。

关于宏任务和微任务，参考 [事件流、事件模型、事件循环概念理解？][6] [浏览器线程理解与microtask与macrotask][7]

ES6新引入了Promise标准，同时浏览器实现上多了一个microtask微任务概念。在ECMAScript中，microtask称为`jobs`，macrotask可称为`task`。
...
<p id="pIPniwI">
  <img loading="lazy" class="alignnone wp-image-4480 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cff1040a286c.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cff1040a286c.png?x-oss-process=image/format,webp" alt="" width="530" height="403" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cff1040a286c.png?x-oss-process=image/format,webp 1263w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cff1040a286c.png?x-oss-process=image/quality,q_50/resize,m_fill,w_300,h_228/format,webp 300w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cff1040a286c.png?x-oss-process=image/quality,q_50/resize,m_fill,w_768,h_584/format,webp 768w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cff1040a286c.png?x-oss-process=image/quality,q_50/resize,m_fill,w_789,h_600/format,webp 789w" sizes="(max-width: 530px) 100vw, 530px" />
</p>
...
<p id="MWwjmxP">
  <img loading="lazy" width="1956" height="558" class="alignnone size-full wp-image-4446 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cf8d96bd576c.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cf8d96bd576c.png?x-oss-process=image/format,webp" alt="" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cf8d96bd576c.png?x-oss-process=image/format,webp 1956w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cf8d96bd576c.png?x-oss-process=image/quality,q_50/resize,m_fill,w_300,h_86/format,webp 300w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cf8d96bd576c.png?x-oss-process=image/quality,q_50/resize,m_fill,w_768,h_219/format,webp 768w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cf8d96bd576c.png?x-oss-process=image/quality,q_50/resize,m_fill,w_800,h_228/format,webp 800w" sizes="(max-width: 1956px) 100vw, 1956px" />
</p>
...
<img loading="lazy" class="alignnone " src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/03/408483-20160525182943272-204994049.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/03/408483-20160525182943272-204994049.png?x-oss-process=image/format,webp" width="409" height="389" /> 
...
<p id="AgWvRBi">
  <img loading="lazy" class="alignnone wp-image-4452 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cfa220da0442.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cfa220da0442.png?x-oss-process=image/format,webp" alt="" width="238" height="339" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cfa220da0442.png?x-oss-process=image/format,webp 512w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cfa220da0442.png?x-oss-process=image/quality,q_50/resize,m_fill,w_210,h_300/format,webp 210w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cfa220da0442.png?x-oss-process=image/quality,q_50/resize,m_fill,w_421,h_600/format,webp 421w" sizes="(max-width: 238px) 100vw, 238px" />
</p>
...
<p id="KAgZpED">
  <img loading="lazy" class="alignnone wp-image-4494 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cff57dd51ef3.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cff57dd51ef3.png?x-oss-process=image/format,webp" alt="" width="547" height="435" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cff57dd51ef3.png?x-oss-process=image/format,webp 1202w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cff57dd51ef3.png?x-oss-process=image/quality,q_50/resize,m_fill,w_300,h_239/format,webp 300w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cff57dd51ef3.png?x-oss-process=image/quality,q_50/resize,m_fill,w_768,h_611/format,webp 768w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5cff57dd51ef3.png?x-oss-process=image/quality,q_50/resize,m_fill,w_754,h_600/format,webp 754w" sizes="(max-width: 547px) 100vw, 547px" />
</p>
...
<span lang="EN-US" xml:lang="EN-US">5. <wbr /> <wbr /></span> 引用类型值：按引用访问，当查询时，我们需要先从栈中读取内存地址，然后再顺藤摸瓜地找到保存在堆内存中的值；

<p id="ZRnBsij">
  <img loading="lazy" width="484" height="297" class="alignnone size-full wp-image-4507 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0afd5edbdeb.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0afd5edbdeb.png?x-oss-process=image/format,webp" alt="" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0afd5edbdeb.png?x-oss-process=image/format,webp 484w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0afd5edbdeb.png?x-oss-process=image/quality,q_50/resize,m_fill,w_300,h_184/format,webp 300w" sizes="(max-width: 484px) 100vw, 484px" />
</p>

数据复制

<li id="KytTpBk">
  基本类型变量的复制：从一个变量向一个变量复制时，会在栈中创建一个新值，然后把值复制到为新变量分配的位置上；<img loading="lazy" width="297" height="446" class="alignnone size-full wp-image-4508 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0afe30bcf21.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0afe30bcf21.png?x-oss-process=image/format,webp" alt="" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0afe30bcf21.png?x-oss-process=image/format,webp 297w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0afe30bcf21.png?x-oss-process=image/quality,q_50/resize,m_fill,w_200,h_300/format,webp 200w" sizes="(max-width: 297px) 100vw, 297px" />
</li>
  * 引用类型变量的复制：复制的是存储在栈中的指针，将指针复制到栈中未新变量分配的空间中，而这个指针副本和原指针执行存储在堆中的同一个对象；复制操作结束后，两个变量实际上将引用同一个对象；因此改变其中的一个，将影响另一个；

<p id="PQFtzrY">
  <img loading="lazy" class="alignnone wp-image-4509 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b26376a752.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b26376a752.png?x-oss-process=image/format,webp" alt="" width="515" height="305" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b26376a752.png?x-oss-process=image/format,webp 633w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b26376a752.png?x-oss-process=image/quality,q_50/resize,m_fill,w_300,h_178/format,webp 300w" sizes="(max-width: 515px) 100vw, 515px" />
</p>
...
<p id="jFaEega">
  <img loading="lazy" class="alignnone wp-image-4510 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b2745d52c9.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b2745d52c9.png?x-oss-process=image/format,webp" alt="" width="473" height="486" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b2745d52c9.png?x-oss-process=image/format,webp 704w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b2745d52c9.png?x-oss-process=image/quality,q_50/resize,m_fill,w_292,h_300/format,webp 292w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b2745d52c9.png?x-oss-process=image/quality,q_50/resize,m_fill,w_583,h_600/format,webp 583w" sizes="(max-width: 473px) 100vw, 473px" />
</p>
...
<p id="uyKMyEp">
  <img loading="lazy" class="alignnone wp-image-4511 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b30f1bac8c.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b30f1bac8c.png?x-oss-process=image/format,webp" alt="" width="617" height="115" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b30f1bac8c.png?x-oss-process=image/format,webp 773w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b30f1bac8c.png?x-oss-process=image/quality,q_50/resize,m_fill,w_300,h_56/format,webp 300w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b30f1bac8c.png?x-oss-process=image/quality,q_50/resize,m_fill,w_768,h_143/format,webp 768w" sizes="(max-width: 617px) 100vw, 617px" />
</p>

插入链表节点：

<p id="ezEjydM">
  <img loading="lazy" class="alignnone wp-image-4512 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b31066cb9b.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b31066cb9b.png?x-oss-process=image/format,webp" alt="" width="605" height="176" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b31066cb9b.png?x-oss-process=image/format,webp 766w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b31066cb9b.png?x-oss-process=image/quality,q_50/resize,m_fill,w_300,h_87/format,webp 300w" sizes="(max-width: 605px) 100vw, 605px" />
</p>

删除链表节点：

<p id="rraTksw">
  <img loading="lazy" class="alignnone wp-image-4513 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b313ca4951.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b313ca4951.png?x-oss-process=image/format,webp" alt="" width="702" height="184" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b313ca4951.png?x-oss-process=image/format,webp 937w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b313ca4951.png?x-oss-process=image/quality,q_50/resize,m_fill,w_300,h_79/format,webp 300w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b313ca4951.png?x-oss-process=image/quality,q_50/resize,m_fill,w_768,h_202/format,webp 768w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b313ca4951.png?x-oss-process=image/quality,q_50/resize,m_fill,w_800,h_210/format,webp 800w" sizes="(max-width: 702px) 100vw, 702px" />
</p>

双向链表：

<p id="UsTRVKd">
  <img loading="lazy" class="alignnone wp-image-4514 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b31659abb2.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b31659abb2.png?x-oss-process=image/format,webp" alt="" width="771" height="144" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b31659abb2.png?x-oss-process=image/format,webp 952w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b31659abb2.png?x-oss-process=image/quality,q_50/resize,m_fill,w_300,h_56/format,webp 300w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b31659abb2.png?x-oss-process=image/quality,q_50/resize,m_fill,w_768,h_144/format,webp 768w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b31659abb2.png?x-oss-process=image/quality,q_50/resize,m_fill,w_800,h_150/format,webp 800w" sizes="(max-width: 771px) 100vw, 771px" />
</p>

循环链表：

<p id="jCMqZUT">
  <img loading="lazy" width="728" height="178" class="alignnone size-full wp-image-4515 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b318083156.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b318083156.png?x-oss-process=image/format,webp" alt="" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b318083156.png?x-oss-process=image/format,webp 728w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0b318083156.png?x-oss-process=image/quality,q_50/resize,m_fill,w_300,h_73/format,webp 300w" sizes="(max-width: 728px) 100vw, 728px" />
</p>
...
<p id="Asamezr">
  <img loading="lazy" class="alignnone wp-image-4505 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0af0212f5fe.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0af0212f5fe.png?x-oss-process=image/format,webp" alt="" width="694" height="498" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0af0212f5fe.png?x-oss-process=image/format,webp 1514w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0af0212f5fe.png?x-oss-process=image/quality,q_50/resize,m_fill,w_300,h_215/format,webp 300w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0af0212f5fe.png?x-oss-process=image/quality,q_50/resize,m_fill,w_768,h_551/format,webp 768w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0af0212f5fe.png?x-oss-process=image/quality,q_50/resize,m_fill,w_800,h_574/format,webp 800w" sizes="(max-width: 694px) 100vw, 694px" />
</p>

<p id="LnNSRjW">
  <img loading="lazy" class="alignnone wp-image-4506 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0af1df488c8.png?x-oss-process=image/quality,q_10/resize,m_lfit,w_200" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0af1df488c8.png?x-oss-process=image/format,webp" alt="" width="687" height="561" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0af1df488c8.png?x-oss-process=image/format,webp 1534w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0af1df488c8.png?x-oss-process=image/quality,q_50/resize,m_fill,w_300,h_245/format,webp 300w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0af1df488c8.png?x-oss-process=image/quality,q_50/resize,m_fill,w_768,h_627/format,webp 768w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0af1df488c8.png?x-oss-process=image/quality,q_50/resize,m_fill,w_735,h_600/format,webp 735w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/06/img_5d0af1df488c8.png?x-oss-process=image/quality,q_50/resize,m_fill,w_320,h_260/format,webp 320w" sizes="(max-width: 687px) 100vw, 687px" />
</p>
