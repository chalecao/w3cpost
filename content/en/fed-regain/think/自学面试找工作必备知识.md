...
如果你想踏入[前端](https://www.w3cdoc.com)学习，准备在走向[前端](https://www.w3cdoc.com)生涯，那么你该好好准备了。如果你想进入网易、百度、阿里这样的大公司，那你更要好好学习下面这些知识点，基础的知识要打牢，否则很难通过笔试或者面试哦。快快行动吧！
  ...
  <img loading="lazy" width="450" height="250" class="alignnone size-full wp-image-5525 shadow" src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2020/01/img_5e0c5b468638c.png" data-src="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2020/01/img_5e0c5b468638c.png?x-oss-process=image/format,webp" alt="" srcset="https://haomou.oss-cn-beijing.aliyuncs.com/upload/2020/01/img_5e0c5b468638c.png?x-oss-process=image/format,webp 450w, https://haomou.oss-cn-beijing.aliyuncs.com/upload/2020/01/img_5e0c5b468638c.png?x-oss-process=image/quality,q_50/resize,m_fill,w_300,h_167/format,webp 300w" sizes="(max-width: 450px) 100vw, 450px" />
...
```
&lt;span class="hljs-keyword">var&lt;/span> aa = &lt;span class="hljs-string">'test string'&lt;/span>;
alert(&lt;span class="hljs-keyword">typeof&lt;/span> aa); &lt;span class="hljs-comment">// 'string'&lt;/span>
alert(&lt;span class="hljs-keyword">typeof&lt;/span> &lt;span class="hljs-number">90&lt;/span>); &lt;span class="hljs-comment">// 'number'&lt;/span>
```
...
```
A：&lt;span class="hljs-keyword">return&lt;/span> &lt;span class="hljs-keyword">false&lt;/span> --->In event handler ,prevents &lt;span class="hljs-keyword">default&lt;/span> behavior &lt;span class="hljs-keyword">and&lt;/span> event bubbing 。
