...
date: 2019-07-27T04:15:10+00:00
url: /html5css3/4849.html
featured_image: https://haomou.oss-cn-beijing.aliyuncs.com/upload/;https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/07/img_5d3bd806ad499.png
fifu_image_url:
  - https://haomou.oss-cn-beijing.aliyuncs.com/upload/2019/07/img_5d3bd806ad499.png
fifu_image_alt:
  - 如何高效响应用户触摸动作
views:
  - 1052
...
在大多数移动浏览器上，系统会在用户点按某个元素后对其应用 _hover_ 和/或 _focus_ 状态。

请认真考虑所设置的样式以及用户完成触摸后会看到的外观。

<aside class="note">
  <strong>Note:</strong> 定位标记和按钮在不同浏览器中可能有不同的行为，因此可以假定在某些情况下保持 <strong>hover</strong> 状态，在其他情况下保持 <strong>focus</strong> 状态。
</aside>
