...
<button class="VJbwyy" type="button" aria-label=""><i class="anticon anticon-copy" aria-label="icon: copy"></i></button>
```
...
* @param  {[type]} xpromise1中onFulfilled的返回值
* @param  {[type]} resolvepromise2的resolve方法
