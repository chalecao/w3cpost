...
可接下来怎么办呢？[我们](https://www.w3cdoc.com)知道和的导数等于导数的和，所以[我们](https://www.w3cdoc.com)可以先把求和符号<span id="MathJax-Element-117-Frame" class="MathJax_SVG" role="textbox" aria-readonly="true"></span>里面的导数求出来，然后再把它们加在一起就行了，也就是
